...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
uint32_t t=0;          		// time for u_sine
uint32_t old_t=0;      		// last time
uint32_t new_t=0;      		// actual time
uint32_t u_sine=0;     		// momentary value of sinusoidal voltage (from 0 to 4095)
